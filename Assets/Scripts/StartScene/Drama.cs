                ...
                case (int)dramaScene.Chapter0:
                    ...
                    switch (textContent)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            guiText.text = "公园里，石子路上悄无一人，一旁的灌木丛中，似有什么小动物。";
                            textContent = 3;
                            break;
                        case 3:
                            guiText.text = "待在一个摇篮里。在朦胧夜色的掩映下，它的身影若隐若现；它是谁，为什么会在这个地方？";
                            textContent = 4;
                            break;
                        case 4:
                ...
                case (int)dramaScene.Chapter1:
                    switch (textContent)
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            guiText.text = "小外星人究竟从何而来并不重要，重要的是，孤独的男孩儿终于有了伙伴。";
                            textContent = 2;
                            break;
                        case 2:
                            guiText.text = "小外星人年纪不大，凡事都需要小男孩儿照顾。";
                            textContent = 3;
                            break;
                        case 3:
                            guiText.text = "小男孩儿与单身母亲相依为命，可是由于工作忙碌加上心情糟糕，母亲时常会忽视和孩子的关爱和沟通。";
                            textContent = 4;
                            break;
                        case 4:
                ...
                case (int)dramaScene.Mission1:
                    switch (textContent)
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            guiText.text = "在他们之间，建立起一种奇妙的心灵感应，E.T.难过的时候，艾里奥特也会感觉忧郁，E.T.病了，艾里奥特也跟着不舒服。";
                            textContent = 2;
                            break;
                        case 2:
                            guiText.text = "孤独的E.T.和孤独的艾里奥特成了最好的朋友，于是他们都不再孤独。";
                            textContent = 3;
                            break;
                        default:
                            SceneManager.LoadScene("mainui", LoadSceneMode.Single);
                ...
                case (int)dramaScene.Mission2:
                    switch (textContent)
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            guiText.text = "直到有一天，E.T.还是不可避免地被大人们发现了。于是警察、军队、FBI……蜂拥而至";
                            textContent = 2;
                            break;
                        case 2:
                            guiText.text = "大人们不顾孩子们的苦苦哀求，无情地抓走了E.T.，根本无视此时的它是那么的无辜、脆弱和绝望，他们只想把这个外星人当成千载难逢的珍贵试验品进行研究。";
                            textContent = 3;
                            break;
                        case 3:
                            guiText.text = "艾里奥特在哥哥和伙伴们的帮助下终于从研究中心救出了九死一生的E.T.，不料大人们根本没有放过他们，沿路设下重重关卡意图拦截这支“营救小队”";
                            textContent = 4;
                            break;
                        case 4:
                            guiText.text = "就在大人的眼皮底下，E.T.展现了它不可思议的神奇力量，带着大家摆脱了“包围圈”";
                            textContent = 5;
                            break;
                        default:
                            SceneManager.LoadScene("mainui", LoadSceneMode.Single);
                ...
                case (int)dramaScene.Mission3:
                    switch (textContent)
                    {
                        case 0:
                            ...
                            break;
                        case 1:
                            guiText.text = "在当初发现E.T.的树林里，来接E.T.回去的外星飞船赶来了";
                            textContent = 2;
                            break;
                        case 2:
                            guiText.text = "一直念念不忘要回家的E.T.终于要走了";
                            textContent = 3;
                            break;
                        case 3:
                            guiText.text = "艾里奥特恋恋不舍地和他的外星朋友告别，望着远去的飞船划破天际艳丽的夕阳";
                            textContent = 4;
                            break;
                        case 4:
                            guiText.text = "艾里奥特知道，他将会永远永远记住这段短暂却美丽的友谊";
                            textContent = 5;
                            break;
                        default:
                            SceneManager.LoadScene("mainui", LoadSceneMode.Single);
